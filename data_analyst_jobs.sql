...
--10.	Add the code to order the query in #9 from highest to 
--lowest average star rating. Which company with more than 5000 reviews across all locations in the
--dataset has the highest star rating? What is that rating? Unilever, GM, Nike, 4.2
...
--**BONUS:**
--You want to understand which jobs requiring SQL are hard to fill. Find the number of jobs by industry (domain) 
...
--Consulting and Business Services(57), and Health Care (52)
